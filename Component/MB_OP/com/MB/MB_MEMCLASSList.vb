...
#Region "Ted Function"
    ...
    Public Function getMail_TO(ByVal iMB_SEQ As Decimal, ByVal iMB_BATCH As Decimal) As Integer
        Try
            ...
            sqlStr = "SELECT B.MB_EMAIL, B.MB_NAME, A.* " & _
                     "  FROM MB_MEMCLASS A, MB_MEMBER B " & _
                     " WHERE     A.MB_SEQ = " & ProviderFactory.PositionPara & "MB_SEQ " & _
                     "       AND A.MB_BATCH = " & ProviderFactory.PositionPara & "MB_BATCH " & _
                     "       AND IFNULL(MB_FWMK, ' ') NOT IN ('3', '4') " & _
