Public Class SY_REL_BRANCH_USER_HIS_dbMeta
   ...
   Private  m_arryPrimaryKeys As New System.Collections.ArrayList
     Sub init() Implements com.Azion.NET.VB.DBMetaData.init
			...
			hMetaData5.add("COLUMN_NAME", "SUBFLOW_SEQ" )
			...
			hMetaData6.add("COLUMN_NAME", "SUBFLOW_COUNT" )
			...
			hMetaData7.add("COLUMN_NAME", "APPROVED" )
